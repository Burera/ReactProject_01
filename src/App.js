...
import port from './assets/img/portfolio/01-thumbnail.jpg';
import port2 from './assets/img/portfolio/02-thumbnail.jpg';
import port3 from './assets/img/portfolio/03-thumbnail.jpg';
import port4 from './assets/img/portfolio/04-thumbnail.jpg';
import port5 from './assets/img/portfolio/05-thumbnail.jpg';
import port6 from './assets/img/portfolio/06-thumbnail.jpg';
function App(){
 console.log(port);
    const portfolioLinks = [
      ...
      const serviceslinks = [
        {
          icon : <i className="fa fa-desktop nope"></i>,
          title: 'E-Commerce',
        ...
        {
            icon : <i className="fa fa-envelope-open nope"></i>,
          title: 'Responsive Design',
          text: 'No design skills needed. You have complete control over the look and feel of your website, from its layout, to content and colors.'
        },
        {
            icon : <i className="fa  fa-shopping-cart nope"></i>,
          title: 'Web Security',
          text: 'No design skills needed. You have complete control over the look and feel of your website, from its layout, to content and colors.'
        }
 ...
 return (
    ...
    <nav className="navbar navbar-expand-lg navbar-dark fixed-top bg-dark" id="mainNav">
            <div className="container">
                <a className="navbar-brand js-scroll-trigger" href="#page-top">Navbar</a><button className="navbar-toggler navbar-toggler-right" type="button" data-toggle="collapse" data-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation">Menu<i className="fa fa-bars ml-1"></i></button>
        ...
        <header className="masthead jumbotron jumbotron-fluid">
          <div className="pt-5 pb-5"></div>
            <div className="container  pt-5 pb-5">
              <div className="pt-5 mt-5">
                <div className="masthead-subheading display-4">Welcome To Our Studio!</div>
                <div className="masthead-heading text-uppercase lead pt-5">It's Nice To Meet You</div>
                <a className="btn btn-primary btn-xl text-uppercase js-scroll-trigger mt-3" href="#services">Tell Me More</a>
                        ...
                        <div className="row justify-content-center">
                            <div className="col-lg-8">
                                <div className="modal-body">
                                    ...
                                    <button className="btn btn-primary" data-dismiss="modal" type="button"><i className="fa fa-times mr-1"></i>Close Project</button>
                                </div>
                            </div>
                        </div>
                    </div>
